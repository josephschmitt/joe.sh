...
<Figure src="safari-tabs.png" caption="Lots of tabs in Safari" />

Or if you're a [crazy Chrome user](http://craigiam.tumblr.com/), like this:

<Figure src="chrome-tabs.png" caption="Lots of tabs in Chrome" />
...
<Figure src="snipe-ui.jpg" caption="Snipe User Interface" />
