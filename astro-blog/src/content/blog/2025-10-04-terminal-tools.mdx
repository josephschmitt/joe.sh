...
status: Published
heroImage: "/assets/images/blog/terminal-tools/hero.jpg"
---
...
<Figure src="/assets/images/blog/terminal-tools/terminal.png" caption="My terminal setup" />

It's where all my terminal configurations live: shell, editor, Tmux, Git, everything.
