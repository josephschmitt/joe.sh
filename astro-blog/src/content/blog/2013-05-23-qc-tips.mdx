...
theme: blue
code: true
heroImage: "/assets/images/blog/qc-tips/hero.jpg"
---
...
<Figure src="/assets/images/blog/qc-tips/real-size.jpg" caption="Real Size Dimensions Mode" />
...
<Figure src="/assets/images/blog/qc-tips/pixel-sprite.jpg" caption="The Pixel Sprite" />
...
<Figure src="/assets/images/blog/qc-tips/pixel-sprite-parameters.jpg" caption="Pixel Sprite Parameters" />
...
```
var myFirstInput = inputNumber[0];
...
```
function (__number resultingValue, __boolean hasBeenSet) main (__number xPosition, __number yPosition)
{
    var result = new Object();
...
<Figure src="/assets/images/blog/qc-tips/javascript-patch.jpg" caption="The JavaScript Patch" />
...
<Figure src="/assets/images/blog/qc-tips/input-splitters.jpg" caption="Input Splitter Madness" />
...
<Figure src="/assets/images/blog/qc-tips/input-splitter-shortcut.jpg" caption="Input Splitter Shortcut" />
