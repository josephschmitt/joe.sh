...
<Forkme repo="josephschmitt/Clamp.js"  />
...
<Figure src="/assets/images/blog/clamp-js/working-css-clamp.jpg" caption="Properly clamped text" />
...
<Figure src="/assets/images/blog/clamp-js/failed-css-clamp.jpg" caption="Failure when there's a link at the end" />
